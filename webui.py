...
def change_label(path_list):
    ...
    if p_label == None:
        ...
        yield i18n("打标工具WebUI已开启"), {"__type__": "update", "visible": False}, {
            "__type__": "update",
            "visible": True,
        }
        print(cmd)
        ...
        p_label = None
        yield i18n("打标工具WebUI已关闭"), {"__type__": "update", "visible": True}, {
            "__type__": "update",
            "visible": False,
        }
...
def change_uvr5():
    ...
    if p_uvr5 == None:
        ...
        yield i18n("UVR5已开启"), {"__type__": "update", "visible": False}, {
            "__type__": "update",
            "visible": True,
        }
        print(cmd)
        ...
        p_uvr5 = None
        yield i18n("UVR5已关闭"), {"__type__": "update", "visible": True}, {
            "__type__": "update",
            "visible": False,
        }
...
def change_tts_inference(
    ...
    if p_tts_inference == None:
        ...
        yield i18n("TTS推理进程已开启"), {"__type__": "update", "visible": False}, {
            "__type__": "update",
            "visible": True,
        }
        print(cmd)
        ...
        p_tts_inference = None
        yield i18n("TTS推理进程已关闭"), {"__type__": "update", "visible": True}, {
            "__type__": "update",
            "visible": False,
        }
...
def open_asr(
    ...
    if p_asr == None:
        ...
        yield "已有正在进行的ASR任务，需先终止才能开启下一次任务", {
            "__type__": "update",
            "visible": False,
        }, {"__type__": "update", "visible": True}, {"__type__": "update"}, {
            "__type__": "update"
        }, {
            "__type__": "update"
        }
...
def open_slice(
    ...
    if os.path.isfile(inp):
        ...
        yield "输入路径存在但既不是文件也不是文件夹", {
            "__type__": "update",
            "visible": True,
        }, {"__type__": "update", "visible": False}, {"__type__": "update"}, {
            "__type__": "update"
        }, {
            "__type__": "update"
        }
...
def open1a(inp_text, inp_wav_dir, exp_name, gpu_numbers, bert_pretrained_dir):
    ...
    if ps1a == []:
        ...
        ps1a = []
        if len("".join(opt)) > 0:
            yield "文本进程成功", {"__type__": "update", "visible": True}, {
                "__type__": "update",
                "visible": False,
            }
        else:
            yield "文本进程失败", {"__type__": "update", "visible": True}, {
                "__type__": "update",
                "visible": False,
            }
    else:
...
def switch_version(version_):
    ...
    if (
        pretrained_sovits_name[-int(version[-1]) + 2] != ""
        and pretrained_gpt_name[-int(version[-1]) + 2] != ""
    ):
        ...
    else:
    ...
    return (
        ...
        {
            "__type__": "update",
            "value": pretrained_sovits_name[-int(version[-1]) + 2].replace(
                "s2G", "s2D"
            ),
        },
    ...
    with gr.Tabs():
        with gr.TabItem(
            ...
            with gr.Row():
                ...
                open_uvr5 = gr.Button(
                    value=i18n("开启UVR5-WebUI"), variant="primary", visible=True
                )
                close_uvr5 = gr.Button(
                    value=i18n("关闭UVR5-WebUI"), variant="primary", visible=False
                )
            ...
            with gr.Row():
                ...
                def change_size_choices(key):  # 根据选择的模型修改可选的模型尺寸
                    ...
                    return {
                        "__type__": "update",
                        "choices": asr_dict[key]["size"],
                        "value": asr_dict[key]["size"][-1],
                    }
                ...
                def change_precision_choices(key):  # 根据选择的模型修改可选的语言
                    ...
                    return {
                        "__type__": "update",
                        "choices": asr_dict[key]["precision"],
                        "value": precision,
                    }
            ...
            with gr.Row():
                ...
                open_label = gr.Button(
                    value=i18n("开启打标WebUI"), variant="primary", visible=True
                )
                close_label = gr.Button(
                    value=i18n("关闭打标WebUI"), variant="primary", visible=False
                )
            open_label.click(
                change_label, [path_list], [label_info, open_label, close_label]
            )
            close_label.click(
                change_label, [path_list], [label_info, open_label, close_label]
            )
        ...
        with gr.TabItem(i18n("1-GPT-SoVITS-TTS")):
            with gr.Row():
                with gr.Row():
                    ...
                    version_checkbox = gr.Radio(
                        label=i18n("版本"), value=version, choices=["v1", "v2"]
                    )
                with gr.Row():
                    pretrained_s2G = gr.Textbox(
                        label=i18n("预训练的SoVITS-G模型路径"),
                        value=pretrained_sovits_name[-int(version[-1]) + 2],
                        interactive=True,
                        lines=2,
                        max_lines=3,
                        scale=9,
                    ...
                    pretrained_s1 = gr.Textbox(
                        ...
                        value=pretrained_gpt_name[-int(version[-1]) + 2],
                        interactive=True,
                        lines=2,
                        max_lines=3,
                        scale=10,
            ...
            with gr.TabItem(i18n("1C-推理")):
                ...
                with gr.Row():
                    ...
                    with gr.Row():
                        open_tts = gr.Button(
                            value=i18n("开启TTS推理WebUI"),
                            variant="primary",
                            visible=True,
                        )
                        close_tts = gr.Button(
                            value=i18n("关闭TTS推理WebUI"),
                            variant="primary",
                            visible=False,
                        )
                    with gr.Row():
